...
```{r}
#lade die Daten
df <- readr::read_csv2("datasets/stat1-4/Datensatz_novanimal_Uebung_Statistik2.1.csv")
...
# lade Daten
df <- read_csv2("datasets/stat1-4/Datensatz_novanimal_Uebung_Statistik2.3.csv")
